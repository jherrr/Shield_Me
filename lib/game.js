(function (root) {
  ...
  Game.prototype.draw = function () {
    ...
    var objects =
      [this.ship].concat(this.asteroids).concat(this.bullets);
  ...
  Game.prototype.relocateObject = function (object) {
    object.pos[0] = relocate(object.pos[0], Game.DIM_X);
    object.pos[1] = relocate(object.pos[1], Game.DIM_Y);
  }
